...
The \gls{DAGMC}\citeprod{noauthor_direct_nodate} toolkit was introduced as part of the
...
benchmarks\citeprod{snouffer_validation_2011}, as well as during a joint exercise
based on a simplified ITER geometry\citeref{wilson_state---art_2008}, and has since
been used in the majority of 3-D analysis in this project.\citeprod{sawan_three-dimensional_2006,
  sawan_three-dimensional_2010}
