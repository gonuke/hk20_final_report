...
The first concept was a flowing Li$_2$O particulate blanket concept without a
...
determined.\citeprod{sawan_neutronics_2001,mattas_evolve_2000,abdou_exploration_2001}
...
activation, can be performed in either low fluence (\textapprox 1 MW$\cdot$s/m$^2$)
or very low fluence (\textapprox 1 W$\cdot$s/m$^2$) operation mode. The low fluence
...
This analysis led to the conclusion that it is necessary to urgentlyestablish
...
self-sufficiency can be attained.\citeprod{sawan_physics_2006}
...
plan.\citeprod{wong_assessment_2005, abdou_u.s._2005}
...
structural material. The low melting point “FLiBe” (\textapprox 380 \textdegree C) was
used in the DC/FLiBe option while the “FLiNaBe” (\textapprox 305 \textdegree C), was
